...
export function AboutSection() {
  ...
  return (
    <Typography variant="body1" className={classes.about}>
      ...
      Welcome! My name is Seyed Alireza FatemiJahromi. I'm currently an undergraduate student in Computer Engineering at
      Sharif University of Technology, Tehran, Iran. My chief areas of interest are Visual Computing and Machine
      Learning. I'm fascinated by the use of Machine Learning in various fields and applications of Computer Graphics &
